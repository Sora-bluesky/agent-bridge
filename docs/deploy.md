...
起点から現行版までの段が順に走る（この文書の時点なら、4.0からは4.0→4.1→4.2→4.3→4.4→4.5→4.6→4.7→4.8→4.9→4.10、4.3からは4.3→4.4→4.5→4.6→4.7→4.8→4.9）。**ここに起点を並べない。**並べた列挙は版が増えるたびに古くなり、名前の無い版のDBが行き場を失う。
